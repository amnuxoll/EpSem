...
public class PhuJusAgentTest {
     ...
     */
    public PhuJusAgent quickAgentGen(String actStr, String initSensors) {
     ...
     */
    public EpRule quickRuleGen(String actStr, String lhsExt, char action, String rhsExt) throws Exception {
