...
class TFSocketEnv:
    ...
    def __init__(self):
        ...
        # Epsilon is a value representing a percentage (0 = 0%, 1 = 100%) for an explore vs exploit E-Greedy algorithm.
        self.global_epsilon = -1.0      # An epsilon value, that is defined goal-by-goal and remains 
        self.local_epsilon = 0          # An epsilon value to 

        # TODO: fill out comments for new egreedy vars
        self.upper_bound = 1.0          # helper vars to calculate global_epsilon
        self.h_shift = 17
