 ...
 */
public class pytorchDQNAgent implements IAgent {
    ...
    public pytorchDQNAgent(Random random) {
    ...
    public void initialize(Action[] actions, IIntrospector introspector) {
        ...
        ProcessBuilder processBuilder = new ProcessBuilder("python3", "./src/agents/pytorchDQN/pytorchDQN.py", "" + port);
